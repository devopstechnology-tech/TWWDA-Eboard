...
class UpdateSubMinuteRequest extends FormRequest
{
    public function rules(): array
    {
        return [
            ...
            // // minutedetails
            'minute_id'    => RuleSet::create()->required()->string(),
            'agenda_id'    => RuleSet::create()->required()->string(),
            'detail_minute_id' => RuleSet::create()->required()->string(),
            'subdetailminute_id' => RuleSet::create()->required()->string(),
