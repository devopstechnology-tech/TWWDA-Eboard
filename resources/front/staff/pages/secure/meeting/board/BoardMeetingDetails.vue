...
import {useGetSingleBoardMeetingRequest} from '@/common/api/requests/modules/meeting/useMeetingRequest';
...
import AgendaComponent from '@/staff/pages/secure/meeting/board/includes/Agenda.vue';
import ApprovedMinutes from '@/staff/pages/secure/meeting/board/includes/ApprovedMinutes.vue';
import Attendance from '@/staff/pages/secure/meeting/board/includes/Attendance.vue';
import ConflictofInterest from '@/staff/pages/secure/meeting/board/includes/ConflictofInterest.vue';
import Documents from '@/staff/pages/secure/meeting/board/includes/Documents.vue';
import HomeDashBoard from '@/staff/pages/secure/meeting/board/includes/HomeDashBoard.vue';
import MeetingRsvp from '@/staff/pages/secure/meeting/board/includes/MeetingRsvp.vue';
import Members from '@/staff/pages/secure/meeting/board/includes/Members.vue';
import TaskPolls from '@/staff/pages/secure/meeting/board/includes/TaskPolls.vue';
...
const tabs = [
    ...
    {id: 'conflict-of-interest', name: 'Conflict of Interest', component: ConflictofInterest, permissions: ['view conflicts of interest']},
...
const MinuteTemplateSelectionmodal = ref<HTMLDialogElement | null>(null);
...
const {
    handleSubmit, setErrors, setFieldValue, values,
} = useForm<{
...
onMounted(async () => {
    try {
        const data = await useGetSingleBoardMeetingRequest(meetingId);
