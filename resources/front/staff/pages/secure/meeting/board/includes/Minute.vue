...
const onGetMinutesSignatures = async (id: string) => {
    await useGetMinutesSignaturesRequest(id);
    await fetchMinutes();
};
const onCEOApproval = async (id: string) => {
    await useGetCEOApprovalRequest(id);
    await fetchMinutes();
};
const onGetPublishMinutes = async (id: string) => {
