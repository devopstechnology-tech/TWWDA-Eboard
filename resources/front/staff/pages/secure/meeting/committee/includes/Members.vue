...
import {
    useGetCommitteeMembersRequest} from '@/common/api/requests/modules/member/useMemberRequest';
...
import MemberShipPosition from '@/staff/pages/secure/meeting/committee/includes/MemberShipPosition.vue';
...
const getMembers = async () => {
    const data = await useGetCommitteeMembersRequest(committeeId, {paginate: 'false'});
...
<template>
    <div class="card">
        <div class="card-header flex items-center">
            <h2 class="card-header-title h3">Committee Meeting Members</h2>
        ...
        <div class="container-fluid">
            <div class="row" v-if="Memberships">
                <div class="col-lg-3 col-md-4 col-sm-6 mb-3" v-for="(membership, idx) in Memberships" :key="idx">
                    <div class="card card-outline card-primary h-100" v-if="membership.user">
