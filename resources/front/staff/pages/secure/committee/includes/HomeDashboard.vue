...
import {
    useCreateCommitteeMeetingRequest,
    useCreateMeetingRequest,
    useDeleteMeetingRequest,
    useGetCommitteeMeetingsRequest,
    usePublishMeetingRequest,    
    useUpdateCommitteeMeetingRequest,
...
const getMeetings = (committeeId: string) => {
    return useQuery({
        queryKey: ['getCommitteeMeetingsKey'],
        queryFn: async () => {
            const response = await useGetCommitteeMeetingsRequest(committeeId, {paginate: 'false'});
                            ...
                            <div class="product-info">
                                ...
                                <div :class="['row', 'border-top', 'border-bottom', 'border-warning', 
                                    ...
                                    <span>
                                        ...
                                        <router-link v-if="authStore.hasPermission(['view meeting'])"
                                                     :to="{ name: 'CommitteeMeetingDetails',
                                                            params: {
                                                                committeeId: committeeId,
                                                                meetingId: meeting.id,
            ...
            <div class="card card-outline card-success">
                ...
                <div class="card-body">
                    <div class="list-group list-group-flush">
                        <div class="list-group-item p-0"><div class="flex gap-3"><div class="flex-none"><img src="https://app.committeeable.com/img/default_user.svg" class="avatar-img avatar-sm rounded-full" data-uw-rm-alt-original="" role="presentation" alt="" data-uw-rm-alt="SVG"></div> <div><div class="mb-1">
                            Nyariki Felix
                            commented on
                            <a href="https://app.committeeable.com/felix-1/discussions/7f843e-volunteer-team">Volunteer Team</a></div> <div class="text-muted small">
                            1 day ago
                        </div></div></div></div> <div class="list-group-item p-0"><div class="flex gap-3"><div class="flex-none"><img src="https://app.committeeable.com/img/default_user.svg" class="avatar-img avatar-sm rounded-full" data-uw-rm-alt-original="" role="presentation" alt="" data-uw-rm-alt="SVG"></div> <div><div class="mb-1">
                            Cynthia Muriithi
                            commented on
                            <a href="https://app.committeeable.com/felix-1/discussions/7f843e-volunteer-team">Volunteer Team</a></div> <div class="text-muted small">
                            1 day ago
                            ...
                            Cynthia Muriithi
                            created a group
                            <a href="https://app.committeeable.com/felix-1/groups/ae969a-finance-and-administration-committee">Finance and Administration Committee</a></div> <div class="text-muted small">
                            1 day ago
                        </div></div></div></div></div>
                </div>
            </div>
