...
import {useGetSingleBoardMeetingRequest} from '@/common/api/requests/modules/meeting/useMeetingRequest'; // Import your API function
...
const getMeeting = () => {
    return useQuery({
        ...
        queryFn: async () => {
            const response = await useGetSingleBoardMeetingRequest(meetingId);
