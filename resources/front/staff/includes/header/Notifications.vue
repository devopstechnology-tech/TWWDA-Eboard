...
const unreadNotificationCount = computed(() => {
    const count = data.value ? data.value.filter(n => n.read_at === null).length : 0;
    emits('updateCount', count);
    return count;
});
        ...
        <div v-if="FilteredNotifications.length > 0">
            <div class="py-2">
                ...
                <a v-for="notification in FilteredNotifications" :key="notification.id"
                   href="" @click.prevent.stop="updateNotification(notification)"
